...
BEGIN        
    ...
    INSERT INTO Listings  (owner_id, title, location_id, isbn_10, isbn_13, image, author, max_due_date)
    VALUES (ownerId, title, @geoLocationId, isbn10, isbn13, image, author, maxDueDate);
